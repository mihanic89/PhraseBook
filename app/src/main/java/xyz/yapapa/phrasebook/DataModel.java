...
class DataModel {
    ...
    private void initData(String defaultLanguage, String translateLanguage) {
        ...
        body = new ArrayList<>();
        body.add(new Phrase(R.string.body01, "body01", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body02, "body02", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body03, "body03", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body04, "body04", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body05, "body05", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body06, "body06", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body07, "body07", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body08, "body08", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body09, "body09", defaultLanguage, translateLanguage));
        body.add(new Phrase(R.string.body10, "body10", defaultLanguage, translateLanguage));

        emotions = new ArrayList<>();
        emotions.add(new Phrase(R.string.berries01, "emotions01", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions02, "emotions02", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions03, "emotions03", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions04, "emotions04", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions05, "emotions05", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions06, "emotions06", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions07, "emotions07", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions08, "emotions08", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions09, "emotions09", defaultLanguage, translateLanguage));
        emotions.add(new Phrase(R.string.emotions10, "emotions10", defaultLanguage, translateLanguage));
        ...
        verbs = new ArrayList<>();
        verbs.add(new Phrase(R.string.verbs01, "verbs01", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs02, "verbs02", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs03, "verbs03", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs04, "verbs04", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs05, "verbs05", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs06, "verbs06", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs07, "verbs07", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs08, "verbs08", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs09, "verbs09", defaultLanguage, translateLanguage));
        verbs.add(new Phrase(R.string.verbs10, "verbs10", defaultLanguage, translateLanguage));

        adjectives = new ArrayList<>();
        adjectives.add(new Phrase(R.string.adjectives01, "adjectives01", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives02, "adjectives02", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives03, "adjectives03", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives04, "adjectives04", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives05, "adjectives05", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives06, "adjectives06", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives07, "adjectives07", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives08, "adjectives08", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives09, "adjectives09", defaultLanguage, translateLanguage));
        adjectives.add(new Phrase(R.string.adjectives10, "adjectives10", defaultLanguage, translateLanguage));

        phrases = new ArrayList<>();
        phrases.add(new Phrase(R.string.phrases01, "phrases01", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases02, "phrases02", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases03, "phrases03", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases04, "phrases04", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases05, "phrases05", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases06, "phrases06", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases07, "phrases07", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases08, "phrases08", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases09, "phrases09", defaultLanguage, translateLanguage));
        phrases.add(new Phrase(R.string.phrases10, "phrases10", defaultLanguage, translateLanguage));

        pretext = new ArrayList<>();
        pretext.add(new Phrase(R.string.pretext01, "pretext01", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext02, "pretext02", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext03, "pretext03", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext04, "pretext04", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext05, "pretext05", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext06, "pretext06", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext07, "pretext07", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext08, "pretext08", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext09, "pretext09", defaultLanguage, translateLanguage));
        pretext.add(new Phrase(R.string.pretext10, "pretext10", defaultLanguage, translateLanguage));
        ...
        geo.add(new Phrase(R.string.geo40, "\uD84C\uDDED\uD83C\uDDFA", defaultLanguage, translateLanguage));
        ...
        geo.add(new Phrase(R.string.geo60, "\uD84C\uDDED\uD83C\uDDFA", defaultLanguage, translateLanguage));
        ...
        geo.add(new Phrase(R.string.geo70, "\uD84C\uDDED\uD83C\uDDFA", defaultLanguage, translateLanguage));
